...
const active_element = document.querySelector(".active-cases .value");
const new_active_element = document.querySelector(".active-cases .new-value");
...
function fetchData(user_country){
	...
	cases_list = [], recovered_list =[], deaths_list = [], dates = [], active_list =[];
    ...
    var requestOptions = {
      ...
      fetch(`https://api.covid19api.com/live/country/${user_country}/status/confirmed/date/2020-03-21T13:13:30Z`, requestOptions)
...
function updateStats(){
    ...
    active_element.innerHTML = last_entry.Active;
    new_active_element.innerHTML = `+${last_entry.Deaths - before_last_entry.Deaths || 0}`;
}
